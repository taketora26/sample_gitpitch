...
あなたは果物農家で収穫した果物を果物屋さんやりんごジュース屋さんに配送しています。

---

収穫した果物を配送するためにダンボール箱を使っていました。

* りんご屋ジュース屋さんにはりんごが入ったダウンボールしか受け取ってくれません
* 果物屋さんには果物であればなんでも受け取ってくれました。
---
...
クラスの定義時には何の型が入るか決まっていないけども、インスタンス化する際に型を決定する機能のこと
---
...
そして、フルーツ用に箱にフルーツであれば何でも入れられたり、
りんご用に箱にはりんごのみしか入れられないように
する制約を
