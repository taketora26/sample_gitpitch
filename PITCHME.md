...
りんご屋ジュース屋さんには、りんごが入ったダウンボールしか受け取ってくれません。

しかし果物屋さんに配送するときは、果物であればなんでも受け取ってくれました。
---

ジェネリクスが生まれる前までは、
りんご用のダンボール、バナナ用にダンボール、フルーツ用のダンボールをそれぞれダンボール独自に作っていました。

でもやっていることはダンボールに果物を入れて、配送することです。
---
